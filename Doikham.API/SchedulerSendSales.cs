...
{
    public class SchedulerSendSales : IHostedService, IDisposable
    {
        private Timer _timer;
        private readonly IConfiguration _config;

        public SchedulerSendSales( IConfiguration configuration)
        {
        ...
        {
            int intervalTime = Convert.ToInt32(_config.GetSection("SAP")["IntervalTimeSendSale"]);
